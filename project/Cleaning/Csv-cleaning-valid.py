...
with open("yiminglin_csvs/imdb_valid_new_1024.csv") as csvdatei:
    ...
    for row in csv_reader_object:
        ...
        if zeilennummer == 0:
            ...
            with open('imdb_valid_superclean.csv', 'w', newline='') as file:
            ...
            if os.path.isfile(filename):
                ...
                with open('imdb_valid_superclean.csv', 'a', newline='') as file:
                    writer = csv.writer(file)
                    writer.writerow(row)
            else:
                nr_of_deletedPics += 1
    ...
    print(f'Anzahl Bilder in yiminglins valid split war: {zeilennummer-1}') #note: es sind 56087
